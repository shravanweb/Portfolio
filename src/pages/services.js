...
const services = [
    ...
    },
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1533750349088-cd871a92f312', // Replace with your image link
    },
    {
        title: 'Video Design',
        description: 'Producing high-quality videos that tell your story and captivate your audience, from concept to final cut.',
        imageUrl: 'https://images.unsplash.com/photo-1559423125-c08d7d96d649', // Replace with your image link
    },
];
...
const ServicesSection = () => {
    ...
    return (
        <Box sx={{
            py: 10, backgroundColor: darkMode ? '#121212' : '#f3f4f6', color: darkMode ? '#fff' : '#333',  // Dark mode background color
 }}>
            <Container maxWidth="lg">
                <Typography variant="h3" align="center" gutterBottom sx={{ fontWeight: 'bold', marginBottom: 6 }}>
                    Our Services
                ...
                <Grid container spacing={4}>
                    {services.map((service, index) => (
                        <Grid item xs={12} sm={6} md={4} key={index}>
                            <Card sx={{
                                height: '100%', boxShadow: 3, borderRadius: '16px',    backgroundColor: darkMode ? '#1f1f1f' : '#ffffff',
                                ...
                                />
                                <CardContent>
                                    <Typography variant="h5" component="div" sx={{ fontWeight: 'bold', marginBottom: 2, color: darkMode ? '#ffcc00' : '#007fff', }}>
                                        {service.title}
                                    </Typography>
