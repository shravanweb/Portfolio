        ...
        >
            <Container maxWidth="lg">
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="h6" sx={{ mb: 1.5, mt: 2, color: 'var(--accent-color)', fontWeight: 600 }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Box sx={{ mb: 3, p: 3, backgroundColor: darkMode ? 'var(--bg-secondary)' : 'var(--bg-secondary)', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                        <Typography variant="body2" sx={{ color: 'var(--text-color)', lineHeight: 1.9 }}>
